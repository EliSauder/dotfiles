    ...
    wayland.windowManager.hyprland = {
      ...
      settings = {
        ...
        layerrule = [
          ...
          "ignore_alpha 0, match:namespace anyrun"
        ...
        windowrule = [
          ...
          "center on, match:title mpv"
          "size 1299 701, match:title mpv"
          "float on, match:title nemo"
          "float on, match:title pavucontrol"
          "no_anim on, match:title ^(REAPER)$"

          "float on, match:class (^wofi$)"
          "center on, match:class (^wofi$)"
          "pin on, match:class (^wofi$)"
          "opaque on, match:class (^wofi$)"
          "opacity 0.3, match:class (^wofi$)"
          "dim_around on, match:class (^wofi$)"
          "stay_focused on, match:class (^wofi$)"
          "no_anim on, match:class (^wofi$)"
          "suppress_event maximize, match:class .*"
          "no_focus on,match:class ^$,match:title ^$wayland:1, match:float 1,match:fullscreen 0,match:pin 0"
          ...
          "workspace 5 silent, match:class ^(steam)$,match:title ^(notification)(.*)$"
          "size 25% 100%, match:class ^(steam)$,match:title ^(Friends List)$"
          "workspace 5 silent, match:class ^(XIVLauncher.Core)$"
          "workspace 4 silent, match:class ^(discord)$"
          "workspace 9 silent, match:class ^(com.obsproject.Studio)$"

          "workspace 2, match:class firefox"
          "workspace 2, match:class .*qutebrowser"

          "workspace 4 silent, match:title (.*)(Outlook)(.*)"
          "workspace 4 silent, match:title (.*)(outlook.office.com)(.*)"
          "fullscreen_state 0 2, match:title (.*)(Outlook)(.*)"
          "fullscreen_state 0 2, match:title (.*)(outlook.office.com)(.*)"
          "workspace 4 silent, match:title (.*)(Microsoft Teams)(.*)"
          "workspace 4 silent, match:title (.*)(teams.microsoft.com)(.*)"
          "fullscreen_state 0 2, match:title (.*)(Microsoft Teams)(.*)"
          "fullscreen_state 0 2, match:title (.*)(teams.micorosft.com)(.*)"

          "workspace 8 silent, match:class ^(factorio)$"
          "workspace 8 silent, match:class ^(steam_app_)(.*)$"
          "fullscreen on, match:class ^(steam_app_)(.*)$"

          "workspace 10, match:title ^(Vivado)(.*)$"
          "center on, match:title ^(Vivado)(.*)$"
          "tile on, match:title ^(Vivado)(.*)$"

          "workspace 3, match:class REAPER, match:initial_title ^(REAPER v[0-9]*)(.*)$"
          "workspace 6, match:class REAPER, match:title ^FX:(.*)$"
          "tile on, match:initial_title ^(REAPER v[0-9]*)(.*)$"
          "tile on, match:title ^FX:(.*)$"
          "no_focus on,match:class REAPER,match:title ^$"
          #"center,match:class REAPER,match:title ^(?!menu)(.*)$"
        ];
        bind = [
