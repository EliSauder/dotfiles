...
in
{
  ...
  config = lib.mkIf cfg.enable {
    ...
    wayland.windowManager.hyprland =
      let
        setupScreenshotsFolder = "uwsm app -- test -d \"$HOME/Pictures/Screenshots\" || mkdir -p \"$HOME/Pictures/Screenshots\" 2>/dev/null";
          ...
          bind = [
            ...
            }
            {
              _args = [
                ...
                (lib.generators.mkLuaInline "hl.dsp.window.fullscreen({action = \"toggle\", mode = \"maximize\"})")
              ];
            }
            {
              _args = [
            ...
            }
            {
              _args = [
                ...
                (lib.generators.mkLuaInline "hl.dsp.float({action = \"toggle\"})")
              ];
            }
            {
              _args = [
...

            {
              _args = [
                ...
                (lib.generators.mkLuaInline "hl.dsp.move({workspace=\"1\", follow=false})")
              ];
            }
            {
              _args = [
                (lib.generators.mkLuaInline "mod .. \" + SHIFT + KP_Down\"")
                (lib.generators.mkLuaInline "hl.dsp.move({workspace=\"2\", follow=false})")
              ];
            }
            {
              _args = [
                (lib.generators.mkLuaInline "mod .. \" + SHIFT + KP_Page_Down\"")
                (lib.generators.mkLuaInline "hl.dsp.move({workspace=\"3\", follow=false})")
              ];
            }
            {
              _args = [
                (lib.generators.mkLuaInline "mod .. \" + SHIFT + KP_Left\"")
                (lib.generators.mkLuaInline "hl.dsp.move({workspace=\"4\", follow=false})")
              ];
            }
            {
              _args = [
                (lib.generators.mkLuaInline "mod .. \" + SHIFT + KP_Begin\"")
                (lib.generators.mkLuaInline "hl.dsp.move({workspace=\"5\", follow=false})")
              ];
            }
            {
              _args = [
                (lib.generators.mkLuaInline "mod .. \" + SHIFT + KP_Right\"")
                (lib.generators.mkLuaInline "hl.dsp.move({workspace=\"6\", follow=false})")
              ];
            }
            {
              _args = [
                (lib.generators.mkLuaInline "mod .. \" + SHIFT + KP_Home\"")
                (lib.generators.mkLuaInline "hl.dsp.move({workspace=\"7\", follow=false})")
              ];
            }
            {
              _args = [
                (lib.generators.mkLuaInline "mod .. \" + SHIFT + KP_Up\"")
                (lib.generators.mkLuaInline "hl.dsp.move({workspace=\"8\", follow=false})")
              ];
            }
            {
              _args = [
                (lib.generators.mkLuaInline "mod .. \" + SHIFT + KP_Page_Up\"")
                (lib.generators.mkLuaInline "hl.dsp.move({workspace=\"9\", follow=false})")
              ];
            }
            {
              _args = [
                (lib.generators.mkLuaInline "mod .. \" + SHIFT + KP_Insert\"")
                (lib.generators.mkLuaInline "hl.dsp.move({workspace=\"10\", follow=false})")
              ];
            }
            {
              _args = [
